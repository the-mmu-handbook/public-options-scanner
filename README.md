...
▶ [Watch the demo](https://github.com/YOUR_USERNAME/public-options-scanner/blob/main/demo/demo.gif)
...
|---|---|
| ![Scanner](demo/scanner.png) | ![Builder](demo/builder.png) |

| GEX | Vol Surface |
|---|---|
| ![GEX](demo/gex.png) | ![Surface](demo/surface.png) |
